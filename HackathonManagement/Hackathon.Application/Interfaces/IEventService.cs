...
public interface IEventService
{
    ...
    Task<(bool Success, string Error)> UpdateEventAsync(Guid id, UpdateEventRequest request);
    Task<(bool Success, string Error)> UpdateEventStatusAsync(Guid id, UpdateEventStatusRequest request);
    ...
    Task<(bool Success, string Error, CategoryResponse? Category)> UpdateCategoryAsync(Guid categoryId, CreateCategoryRequest request);
    Task<(bool Success, string Error)> DeleteCategoryAsync(Guid categoryId);
